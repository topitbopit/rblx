...
2.1.4.5a
 ...
 [*] Fixed sliders SetMin, SetMax, SetValue not firing the value event
 [+] Made messageboxes events be able to be passed with an identifier (check docs for info)
 [*] Fixed tooltips appearing when the menu sidebar is open
